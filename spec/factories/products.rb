FactoryGirl.define do
  ...
  factory :shopbop_product_vince, parent: :product_vince do
  ...
  factory :shopbop_product, parent: :shopbop_product_vince

  factory :product_vince, parent: :product do
    association :brand, name: 'Vince'
    brand_name 'Vince'
  ...
  factory :shopbop_product_suggestion, parent: :shopbop_product do
    association :brand, name: 'Vince'
    brand_name 'Vince'
    source 'test'
    title 'Favorite Tank'
  ...
  factory :shopbop_product_suggestion_rand, parent: :shopbop_product do
    association :brand, name: 'Vince'
    brand_name 'Vince'
    source 'test'
    title 'Favorite Tank'
